...
public class StartUpIdea implements Comparable<StartUpIdea> {
    ...
    private int customerDifficulty;
     ...
     * @param customerDifficulty 1-10 rating of customer acquisition difficulty
     * @param productDifficulty difficulty of creating the product.
     */
    ...
    public StartUpIdea(String problem, String targetCustomer,
                       ...
                       int customerDifficulty, String productDifficulty) {
    ...
    public String toString() {
        ...
        str += "Customer Acquisition Difficulty: " + customerDifficulty + "\n";
        str += "Product Creation Difficulty: " + productDifficulty + "\n";
        return str;
    }
    ...
    public int compareTo(StartUpIdea other) {
        int totalCustomerDesireDiff =
                (int) ((this.customerNeed - Math.round(.2 * this.customerDifficulty))
                        * (this.targetMarketSize + this.knownPeopleWithProblem * 10000)
                        - (other.customerNeed - Math.round(.2 * other.customerDifficulty))
